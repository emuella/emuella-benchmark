...
def build(source, output, sampling=False, execution_diagnostics=False, allocation_diagnostics=False, forward53_diagnostics=False):
    ...
    write(output / 'build.json', dict(benchmark=benchmark, codec=codec, sampling=sampling, execution_diagnostics=execution_diagnostics, allocation_diagnostics=allocation_diagnostics, forward53_diagnostics=forward53_diagnostics,
...
def main():
    ...
    p.add_argument('--forward53-diagnostics',action='store_true')
    ...
    if args.command=='build': build(args.codec_source,args.output,args.sampling,args.execution_diagnostics,args.allocation_diagnostics,args.forward53_diagnostics)
